...
def SavePTLUT(k, ptLUT):
    with open('trackLUT.pickle', 'wb') as handle:
        pickle.dump((k, ptLUT), handle, protocol=pickle.HIGHEST_PROTOCOL)

def SaveEtaLUT(m, etaLUT):
    with open('trackLUT.pickle', 'wb') as handle:
        pickle.dump((m, etaLUT), handle, protocol=pickle.HIGHEST_PROTOCOL)

def SaveLUTs(ptshift, ptLUT, etashift, etaLUT):
    with open('trackLUT.pickle', 'wb') as handle:
        pickle.dump((ptshift, ptLUT, etashift, etaLUT), handle, protocol=pickle.HIGHEST_PROTOCOL)
